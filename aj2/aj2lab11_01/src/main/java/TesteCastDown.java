public class TesteCastDown {
    ...
    public static void main(String[] args) {
        ...
        if (conta instanceof ContaPoupanca) {
        	...
        	ContaEspecial contaEspecial = (ContaEspecial) conta; //cast down para visualizar o limite da conta especial
        	System.out.println("Limite: "+contaEspecial.getLimite());//retornando via get o limite da conta
